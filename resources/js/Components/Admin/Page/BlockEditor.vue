...
import BlockToolbar from './Toolbars/BlockToolbar.vue';
...
<template>
    <div class="editor-block relative bg-white shadow rounded-lg overflow-hidden mb-4 transition-all duration-200 pl-8"
        ...
        <div class="flex items-center justify-between p-2 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <span class="text-xs font-medium text-gray-600">{{ block.type === 'title' ? 'Titre' : block.type ===
                    'text' ? 'Texte' : block.type }}</span>
            </div>
